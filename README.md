...
## Usage
We have provided a convenient wrapper function that simplifies the extraction of time-series data and variables.
bash
```
import os
import sys
...
def wrapper():
    if len(sys.argv) != 3:
        print("Usage: python wrapper_script.py data_input.json output_format (csv or var)")
        sys.exit(1)

    data_input = sys.argv[1]
#    lls_indicators = sys.argv[2]
